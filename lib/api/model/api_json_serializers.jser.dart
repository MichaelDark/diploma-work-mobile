...
abstract class _$RegisterRequestSerializer implements Serializer<RegisterRequest> {
  @override
  ...
  RegisterRequest fromMap(Map map) {
    if (map == null) return null;
    final obj = RegisterRequest(map['email'] as String ?? getJserDefault('email'),
        map['name'] as String ?? getJserDefault('name'), map['password'] as String ?? getJserDefault('password'));
    return obj;
  }
}
...
abstract class _$LoginRequestSerializer implements Serializer<LoginRequest> {
  ...
  LoginRequest fromMap(Map map) {
    ...
    final obj = LoginRequest(
        map['email'] as String ?? getJserDefault('email'), map['password'] as String ?? getJserDefault('password'));
    return obj;
  }
}

abstract class _$ForgotPasswordRequestSerializer implements Serializer<ForgotPasswordRequest> {
  @override
  Map<String, dynamic> toMap(ForgotPasswordRequest model) {
    if (model == null) return null;
    Map<String, dynamic> ret = <String, dynamic>{};
    setMapValue(ret, 'email', model.email);
    return ret;
  ...
  @override
  ForgotPasswordRequest fromMap(Map map) {
    if (map == null) return null;
    final obj = ForgotPasswordRequest(map['email'] as String ?? getJserDefault('email'));
    return obj;
  }
}
